...
if __name__ == "__main__":
    ...
    sequence_java = read_text('D:\SHALAN REP\prog-instruments-labs\lab_5\sequence_java.txt')
    ...
    sequence_cpp = read_text('D:\SHALAN REP\prog-instruments-labs\lab_5\sequence_cpp.txt')
